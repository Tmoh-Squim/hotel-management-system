...
const ContactPage = () => {
  ...
  return (
    <div className="w-full bg-background text-foreground ">
      ...
      {/* Google Map Section */}
      <section className="w-full bg-background text-foreground-100 pt-8">
        <h2 className="text-2xl font-semibold text-center mb-4">
          Our Location
        </h2>
        <div className="w-full h-[500px] mx-auto">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15958.457186261401!2d37.320191726434786!3d-0.5794331169898587!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182629eba31b7635%3A0xddfa1ddd4cefc0b!2sSheila%20Hostels!5e0!3m2!1sen!2ske!4v1741360829317!5m2!1sen!2ske"            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
            loading="lazy"
